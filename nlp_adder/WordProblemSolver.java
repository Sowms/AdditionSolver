...
public class WordProblemSolver {
	...
	public static void main(String[] main) {
		...
		solveWordProblems("There are 22 walnut trees currently in the park . Park workers will plant walnut trees today . When the workers are finished there will be 55 walnut trees in the park . How many walnut trees did the workers plant today ? ", pipeline);
	}
